  ...
  server.registerTool(
    "rf_candidate_search",
    {
      ...
      description: [
        ...
        "",
        "Response warnings: `warning: 'filter_unverified'` means RF was unreachable — results are tier-1 only, mutable filters were not applied. `warning: 'custom_field_unverified'` means `technology`/`segment`/`role` were dropped (custom-field id mapping not yet wired); `_meta.unverifiedFilters` lists which ones.",
        "",
