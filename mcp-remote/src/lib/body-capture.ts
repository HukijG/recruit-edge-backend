...
async function safeReadRequestBody(input: any, init: any): Promise<string | null> {
...
async function streamReadWithBudget(response: Response): Promise<string | null> {
 ...
 * worker for the rationale — this is the TypeScript sibling copy.
 */
 ...
 * `http.response.body` (redacted). TypeScript sibling of the main worker's
 * helper.
 */
